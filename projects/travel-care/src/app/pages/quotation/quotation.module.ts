...
import { DynamicTableSportModule } from '../../module/dynamic-table-sport/dynamic-table-sport.module';
import { DynamicTableMountModule } from '../../module/dynamic-table-mount/dynamic-table-mount.module';
...
@NgModule({
  ...
  imports: [
    ...
    NxGridModule,
    NxHeadlineModule,
    DynamicTableSportModule,
    DynamicTableMountModule,
  ]
})
